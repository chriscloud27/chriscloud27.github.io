...
> = {
  "case-01-capgemini-kubernetes": {
    ...
    description:
      "Multi-tenant Azure Kubernetes platform design for 2,500+ developers with governance, self-service provisioning, and IaC.",
  },
  "case-02-aws-autonomous-driving": {
    title: "Autonomous Driving Platform — MaCh2.cloud",
    description:
      "Cloud infrastructure powering autonomous vehicle development.",
  },
  "case-03-enterprise-saas-optimization": {
  ...
  "case-04-baas-seed-startup": {
    ...
    description:
      "Backend-as-a-Service platform scaling from seed to production.",
  },
};
...
async function getCaseContent(slug: string, locale: string) {
  ...
  try {
    ...
    content = content.replace(
      /href="case-([a-z0-9-]+)\.html"/g,
      `href="/${locale}/cases/case-$1"`,
    );
