...
- Mono accents: JetBrains Mono (for technical elements only)
...
- Architecture diagrams and system visuals preferred over stock photos
...
- Headline line 3 (in Electric Cyan): is the chaos.
- Subheadline: Series A and B SaaS companies move fast — until the
  foundation built to get there starts breaking under the weight of growth.
  I design AI-native cloud architectures that eliminate the technical debt
...
Full brand strategy, ICP, value proposition, and product packages
are in /brand — read these files for any content, copy, or
positioning decisions before writing any text on the site.
